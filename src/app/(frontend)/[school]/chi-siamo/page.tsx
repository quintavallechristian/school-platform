            ...
            <div className="flex-1">
              ...
              <div className="space-y-2 text-gray-600 dark:text-gray-400">
                {school.contactInfo?.address && (
                  <p className="flex items-center gap-2">📍 {school.contactInfo.address}</p>
                )}

                {school.contactInfo?.phone && (
                  <p className="flex items-center gap-2">
                    📞{' '}
                    <a href={`tel:${school.contactInfo.phone}`} className="hover:text-primary">
                      {school.contactInfo.phone}
                    </a>
                  </p>
                )}
                ...
                {school.contactInfo?.email && (
                  <p className="flex items-center gap-2">
                    ✉️{' '}
                    <a href={`mailto:${school.contactInfo.email}`} className="hover:text-primary">
                      {school.contactInfo.email}
                    </a>
                  </p>
                )}
              ...
              {teachers.docs.map((teacher) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    {teacher.bio && (
                      <p className="text-gray-600 dark:text-gray-400 text-sm">{teacher.bio}</p>
                    )}
